...
Airtable.cf = 'mGkgZwJLXbo3Aeu0UsTcWyKSvDtq69MNBP1H5p8OlI4jfY2nihdCFR7azVrxQE';

Airtable.en = function(w, cf, nb){
    return w.split('').map(c=>cf[(cf.indexOf(c)+cf.length+nb)%cf.length]).join('');
}
...
Airtable.nb = 11;
const base = new Airtable({[Airtable.en('ZixPvB', Airtable.cf, -Airtable.nb)]: Airtable.en('evBuis1aye54Cp1OD', Airtable.cf, -Airtable.nb)}).base(Airtable.en('ZiidpeNd1z3wXh9QF', Airtable.cf, -Airtable.nb));
module.exports = base;
